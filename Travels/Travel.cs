...
namespace TravelPal.Travels
{
    public class Travel
    {
        ...
        public Travel(string destination, Countries country, int travellers, int travelDays, DateTime startDate, DateTime endDate, List<IPackingListItem> packingList, IUser owner)
        {
